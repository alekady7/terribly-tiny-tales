    ...
    return (
        <div>
            <div className='mt-8 lg:w-1/3 ml-7 lg:justify-center'>
                <p className='mr-16'>Aspiring Developer at Terribly Tiny Tales</p>
                <a className='text-blue-500 mr-10 pr-9' href='https://www.instagram.com/aditya._uniyal'>https://www.instagram.com/aditya._uniyal</a>
            </div>
